...
import ar.edu.davinci.infraestructure.exception.runtime.ResourceNotFoundException;
...
public abstract class FitmeService<ENTITY extends FitmeEntity, PARENT_ENTITY extends FitmeEntity> {
